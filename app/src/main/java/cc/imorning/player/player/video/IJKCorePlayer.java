package cc.imorning.player.player.video;
...
public class IJKCorePlayer extends JZMediaInterface implements IMediaPlayer.OnPreparedListener,
    ...
    public IJKCorePlayer(Jzvd jzvd) {
        super(jzvd);
    }
    ...
    public void prepare() {
        ...
        release();
        mMediaHandlerThread = new HandlerThread("playerThread");
        ...
        mMediaHandler.post(() -> {
            ...
            ijkMediaPlayer.setOnPreparedListener(IJKCorePlayer.this);
            ijkMediaPlayer.setOnVideoSizeChangedListener(IJKCorePlayer.this);
            ijkMediaPlayer.setOnCompletionListener(IJKCorePlayer.this);
            ijkMediaPlayer.setOnErrorListener(IJKCorePlayer.this);
            ijkMediaPlayer.setOnInfoListener(IJKCorePlayer.this);
            ijkMediaPlayer.setOnBufferingUpdateListener(IJKCorePlayer.this);
            ijkMediaPlayer.setOnSeekCompleteListener(IJKCorePlayer.this);
            ijkMediaPlayer.setOnTimedTextListener(IJKCorePlayer.this);
